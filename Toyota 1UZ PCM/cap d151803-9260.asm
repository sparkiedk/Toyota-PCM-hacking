...
TwoD_RPM:				; CODE XREF: __RESET+2A9p __RESET+4A7p ...
		ld	a, RPM		; lookup unk_F0, integer return	in Acca, fraction return in AccB
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
		.db  8Ch ; å		; cpx... Nop's through the next load
...
byte_C2DB:	.db 12h			; data used by F070 (18)
		...
		.db  2Ch ; ,
		.db 0FFh
unk_C2EA:	.db  86h ; Ü		; C5F4,	lookup for F7
		.db  14h		; 5120
		.db 0D2h ; “
		.db  0Ah		; 2560
		.db 0FFh
		...
		.db  14h
		.db 0FFh
		.db  01h		; Three	D table	RPM by word_f2,	row offset high
		...
		.db  00h
		.db 0FFh
		.db  86h ; Ü		; DF60,	2d lookup for F7
		.db  10h
		.db  86h ; Ü
		.db  0Ah
		.db 0DCh ; ‹
...
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
		.db  8Ch ; å		; cmpx,	effectly three byte NOP	when falling through
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
...
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
		.db 0FEh ; ˛
		.db 0FDh ; ˝		; data used by above sub
		.db 0FBh ; ˚
		.db 0D7h ; ◊
		.db 0AFh ; Ø
		.db  7Fh ; 
...
loc_D525:				; CODE XREF: sub_D3D5+17j __RESET+6Bj
		...
		jmp	loc_D5B6
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
		.db 0B9h ; π		; data for D525	- ram init routine (addr:data, 00 address to quit
		.db  86h ; Ü
		.db  5Fh ; _
		.db 0FFh
		.db 0A8h ; ®
...
loc_EAE2:				; CODE XREF: __RESET+161Ej
					; __RESET+1621j
		st	a, unk_C0	; flag for Gx
		st	a, unk_C1	; flag for Gx
		bra	loc_EB01
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
...
intASR2:				; DATA XREF: ROM:FFFAo
		...
		bne	intASR2_5
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
		.db  8Ch ; å		; cmp x, makes a three byte NOP
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
...
intASR2_30:				; CODE XREF: ROM:EDB5j
		...
		setb	bit5, unk_4E
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
		.db  8Ch ; å		; cmp x, a three byte NOP
; ƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒƒ
