...
unk_1D:		rmb 1			; bits 7..5 appear to count between edges of p1-0? bits	1,0 appear to be dependant on port1
		rmb 1
...
loc_F242:				; CODE XREF: ROM:F1BEJ
		ldaa	unk_18
		ldx	unk_1D		; bits 7..5 appear to count between edges of p1-0? bits	1,0 appear to be dependant on port1
		bita	#2
		beq	loc_F2AC
		stx	word_B7
		ldaa	Port2
...
loc_F4D6:				; CODE XREF: sub_F420+AFj
		ldx	#$FFD2
		jsr	$11,x		; ffe3 entry, plays with ram D1
		bra	loc_F4EB
; ---------------------------------------------------------------------------
...
loc_F8AD:				; CODE XREF: ROM:F8AAj
		...
		jsr	sub_FB46
		eora	ADCRxData
		bcs	loc_F8CD+1	; 4f5f is clra clrb
		ldx	#$5AA
		ldaa	unk_A5
		beq	loc_F8C2
		ldx	#$60E
...
loc_F8C2:				; CODE XREF: ROM:F8BDj
		...
		bcs	loc_F8CD+1	; 4f5f is clra clrb
		ldaa	unk_95
		bmi	loc_F8CD+1	; 4f5f is clra clrb
		ldd	#$FFD6

loc_F8CD:				; CODE XREF: ROM:F8B6j	ROM:F8C4j ...
		cpx	#$4F5F		; 4f5f is clra clrb
		stab	unk_A5
		addb	unk_A4
		adca	#0
		addb	unk_A3
...
loc_FA62:				; CODE XREF: sub_F96A+E0j sub_F96A+E9j
		...
		bcc	loc_FA83
		ldab	#$12
		stab	unk_65		; write	$12 to unk_65
		tsta
		bne	loc_FA75
		ldaa	#1
		oraa	unk_4C
